...
虽然我已经参与 Project NAVI 很久了，但这还是我第一次在 DevLog 上发文。
...
在 Project NAVI 里，我们的伙伴 [@nekomeowww](https://github.com/nekomeowww) 也做了一个丝滑的聊天气泡组件：
...
欢迎来[我们的 UI storybook](https://navi.navichat.ai/ui/#/story/src-components-gadgets-chatbubbleminimalism-story-vue?variantId=chat) 看看
...
尽管它的核心代码不到 100 行，如果你也想在项目里把 UTF-8 字节流做成炫酷的文本动画（比如我们在 Project NAVI 里做的那样），它或许能帮到你。

如果你对 Project NAVI 感兴趣，也欢迎来我们的 GitHub 仓库 [navichat/navi](https://github.com/navichat/navi) 看看！
