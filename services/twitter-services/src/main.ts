...
import type { NaviAdapter } from './adapters/navi-adapter'
 ...
 */
async function cleanup(adapters: { navi?: NaviAdapter, mcp?: MCPAdapter }, browserCtx: Context) {
 ...
 */
function setupShutdownHooks(adapters: { navi?: NaviAdapter, mcp?: MCPAdapter }, browserCtx: Context) {
