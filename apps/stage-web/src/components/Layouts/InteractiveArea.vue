...
import WhisperWorker from '@proj-navi/stage-ui/libs/workers/worker?worker&url'

import { toWAVBase64 } from '@proj-navi/audio'
import { useMicVAD, useWhisper } from '@proj-navi/stage-ui/composables'
...
import { useSettings, useSettingsAudioDevice } from '@proj-navi/stage-ui/stores/settings'
